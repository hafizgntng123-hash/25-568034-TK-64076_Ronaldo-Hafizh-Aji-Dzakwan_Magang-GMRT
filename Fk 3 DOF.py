...
x = L1 * math.cos(t1) + L2 * math.cos(t1+t2) + L3 * math.cos(t1+t2) 
y = L1 * math.sin(t1) + L2 * math.sin(t1+t2) + L3 * math.sin(t1+t2)

# berikan perintah untuk menampilkan hasil
print("\nHasil ujung lengan robot dengan 3 DOF")  #agar mendapat 2 angka dibelakang koma saja
